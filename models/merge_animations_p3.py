"""
Blender script to merge P3 animation GLB files into one.
Run with: blender --background --python merge_animations_p3.py
"""
...
P3_DIR = os.path.join(MODELS_DIR, "p3")

BASE_FILE = "Meshy_AI_Animation_Idle_5_P3_withSkin.glb"
ANIM_FILES = {
    'idle': 'Meshy_AI_Animation_Idle_5_P3_withSkin.glb',
    'left': 'Meshy_AI_Animation_Cautious_Crouch_Walk_Left_inplace_P3_withSkin.glb',
    'right': 'Meshy_AI_Animation_Cautious_Crouch_Walk_Right_inplace_P3_withSkin.glb',
    'cast_loop': 'Meshy_AI_Animation_mage_soell_cast_5_P3_withSkin.glb',
    'cast_release': 'Meshy_AI_Animation_mage_soell_cast_3_P3_withSkin.glb',
    'victory': 'Meshy_AI_Animation_Cherish_Pop_Dance_P3_withSkin.glb',
    'defeat': 'Meshy_AI_Animation_Angry_Ground_Stomp_1_P3_withSkin.glb',
}

OUTPUT_FILE = "Character_All_Animations_P3.glb"

print(f"Working in: {MODELS_DIR}")
print(f"P3 folder: {P3_DIR}")

# Import base file
base_path = os.path.join(P3_DIR, BASE_FILE)
...
for action_name, filename in ANIM_FILES.items():
    ...
    filepath = os.path.join(P3_DIR, filename)
