"""
Blender script to merge P2 animation GLB files into one.
Run with: blender --background --python merge_animations_p2.py
"""
...
P2_DIR = os.path.join(MODELS_DIR, "p2")

BASE_FILE = "Meshy_AI_Animation_Idle_5_P2_withSkin.glb"
ANIM_FILES = {
...
OUTPUT_FILE = "Character_All_Animations_P2.glb"

print(f"Working in: {MODELS_DIR}")
print(f"P2 folder: {P2_DIR}")

# Import base file
base_path = os.path.join(P2_DIR, BASE_FILE)
...
for action_name, filename in ANIM_FILES.items():
    ...
    filepath = os.path.join(P2_DIR, filename)
